    ...
    while in_combat and monsters:
        while combat_order:
            ...
            while True:
                try:
                    ...
                    continue
                try:
                    monsters[player_target_choice] in monsters
                except:
                    print("Not in the group of monsters!")
                    continue
                else:
                    break
            ...
            while True:
                try:
                    player_character_choice = int(input("?: \n"))
                except (ValueError):
                    print("Not a number.")
                    continue
                try:
                    heroes[player_character_choice] in heroes
                except:
                    print("Not in the group of heroes!")
                    continue
                else:
                    break
            ...
            if tohit >= monsters[player_target_choice].ac:
                ...
                damageroll = int(random.randrange(int(tohit/4), int(tohit/2)+5))
        ...
        while combat_order == False:
            ...
            if tohit >= heroes[monster_target].ac:
                ...
                heroes[monster_target].hp -= damageroll
...
display_intro()
while not game_won:
    print("\u001b[40;1mROOM:", map_rooms[player_location].number,"\u001b[0m")
    room_description()
